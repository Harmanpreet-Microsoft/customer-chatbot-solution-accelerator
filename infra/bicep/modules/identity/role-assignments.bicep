...
// Deploying User → Search Service Contributor on Azure AI Search
...
// Deploying User → Search Index Data Contributor on Azure AI Search
...
// Deploying User → Search Index Data Reader on Azure AI Search
