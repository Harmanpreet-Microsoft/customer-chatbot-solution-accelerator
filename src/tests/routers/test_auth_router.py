"""
Comprehensive tests for src/api/app/routers/auth.py
...
class TestGetCurrentUserInfo:
    ...
    async def test_create_new_user_with_demo_orders(
        self, mock_get_current_user, mock_get_db_service, mock_create_demo,
        mock_db_service, mock_user
    ):
    ...
    async def test_user_creation_failure_returns_fallback_data(
        ...
        mock_db_service.get_user.side_effect = Exception("Not found")
        mock_db_service.get_user_by_email.side_effect = Exception("Not found")
        mock_db_service.create_user_with_password.side_effect = Exception("Creation failed")
        mock_get_db_service.return_value = mock_db_service
    ...
    @pytest.mark.asyncio
    @patch("app.routers.auth.get_current_user")
    async def test_exception_in_get_current_user_returns_guest(self, mock_get_current_user):
