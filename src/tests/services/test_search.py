"""
Comprehensive tests for Azure AI Search service functions
"""
import os
import sys
...
class TestGetSearchClient:
    ...
    def test_get_search_client_success(self, mock_settings, mock_azure_credential, mock_search_client, mock_has_config):
    ...
    def test_get_search_client_returns_cached(self, mock_settings, mock_azure_credential, mock_search_client, mock_has_config):
    ...
    def test_get_search_client_no_endpoint(self, mock_azure_credential, mock_search_client, mock_has_config):
    ...
    def test_get_search_client_initialization_error(self, mock_settings, mock_azure_credential, mock_search_client, mock_has_config):
...
class TestGetProductSearchClient:
    ...
    def test_get_product_search_client_success(self, mock_settings, mock_azure_credential, mock_search_client, mock_has_config):
    ...
    def test_get_product_search_client_returns_cached(self, mock_settings, mock_azure_credential, mock_search_client, mock_has_config):
    ...
    def test_get_product_search_client_no_endpoint(self, mock_azure_credential, mock_search_client, mock_has_config):
        """Test when endpoint is None"""
        with patch('app.services.search.settings') as mock_settings:
            mock_settings.azure_search_endpoint = None
    ...
    def test_get_product_search_client_initialization_error(self, mock_settings, mock_azure_credential, mock_search_client, mock_has_config):
...
class TestSearchReferenceEnhanced:
    ...
    def test_search_reference_enhanced_with_highlights(self, mock_get_client):
        ...
        setattr(mock_result, "@search.highlights", {"content": ["<mark>highlighted text</mark>"]})
